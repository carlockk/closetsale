...
export default async function CategoriesPage({ searchParams }: CategoriesPageProps) {
  ...
  const closeDrawerHref = "/admin/categories";
  ...
  return (
    <div className="min-w-[720px] space-y-6">
      ...
      <AdminSideDrawer open={isDrawerOpen} closeHref={closeDrawerHref} title="Crear categoria">
        <form action={createCategoryAction} className="grid gap-4 border border-slate-200 bg-white p-4">
          <div className="grid gap-4 md:grid-cols-3">
            ...
            <input
              ...
              className="min-w-0 border border-slate-200 px-3 py-2 text-sm"
            />
            <select name="parentId" className="min-w-0 border border-slate-200 px-3 py-2 text-sm">
