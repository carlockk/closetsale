  ...
  return (
    <div className="fixed bottom-4 right-4 z-[90]">
      ...
      <button
        ...
        className="chat-widget-trigger bg-transparent text-black transition hover:scale-105"
      ...
      >
        ...
        >
          <path
            ...
            fill="currentColor"
          />
          <circle cx="54" cy="67" r="9" fill="#ffffff" />
          <circle cx="90" cy="67" r="9" fill="#ffffff" />
          <circle cx="126" cy="67" r="9" fill="#ffffff" />
        </svg>
      </button>
